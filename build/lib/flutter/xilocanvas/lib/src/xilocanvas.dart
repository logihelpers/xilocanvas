...
class XilocanvasControl extends StatefulWidget {
  ...
  @override
  State<XilocanvasControl> createState() => _XilocanvasControlState();
}

class _XilocanvasControlState extends State<XilocanvasControl> {
  ...
  Widget build(BuildContext context) {
    ...
    var result = StoreConnector<AppState, XilocanvasViewModel>(
        distinct: true,
        ignoreChange: (state) {
          return state.controls[widget.control.id] == null;
        },
        converter: (store) =>
            XilocanvasViewModel.fromStore(store, widget.control, widget.children),
